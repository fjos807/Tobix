...
public class ChatService {
	...
	private static String workspaceId = "e98550e0-84dd-4ec7-815e-fc1543380f6d";
	...
	public Response getResponse(@QueryParam("conversationMsg") String conversationMsg, @QueryParam("conversationCtx") String conversationCtx) {
		...
		String ej = "{\"date\": \"2019-03-30\", \"number\": 2, \"usr\": \"tobix\",\"time\": \"11:00:00\"}";
		JSONObject ctxJsonObj = new JSONObject(ej);
		...
		//System.out.println(conversationCtx);
